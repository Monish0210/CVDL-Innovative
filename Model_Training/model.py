...
class SiamUnet(nn.Module):
    """
    SiamUnet is a Siamese U-Net architecture for change detection.
    It takes two images (pre and post-disaster) as input and outputs segmentation masks.
    """
    def __init__(self, in_channels=3, out_channels_s=2, out_channels_c=5, init_features=16):
        ...
        # UNet layers for both branches (shared weights)
        ...
        # Siamese classifier layers for change detection
    ...
    def forward(self, x1, x2):
        ...
        # UNet on x2 (post-disaster image)
        ...
        # Siamese branch to detect change
        ...
        # The model returns three outputs, but we only need the third one (damage classification) for training
